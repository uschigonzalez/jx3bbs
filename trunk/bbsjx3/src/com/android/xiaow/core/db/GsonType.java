...
public final class GsonType {
	...
	static Type getGenericSupertype(Type context, Class<?> rawType, Class<?> toResolve) {
		...
		if (toResolve.isInterface()) {
			...
			for (int i = 0, length = interfaces.length; i < length; i++) {
				...
				} else if (toResolve.isAssignableFrom(interfaces[i])) { return getGenericSupertype(
		...
		if (!rawType.isInterface()) {
			while (rawType != Object.class) {
				...
				} else if (toResolve.isAssignableFrom(rawSupertype)) { return getGenericSupertype(
	...
	static Type getSupertype(Type context, Class<?> contextRawType, Class<?> supertype) {
		...
		return resolve(context, contextRawType,
				GsonType.getGenericSupertype(context, contextRawType, supertype));
	}
	...
	public static Type getCollectionElementType(Type context, Class<?> contextRawType) {
		...
		if (collectionType instanceof ParameterizedType) { return ((ParameterizedType) collectionType)
	...
	public static Type[] getMapKeyAndValueTypes(Type context, Class<?> contextRawType) {
		 ...
		 */
		if (context == Properties.class) { return new Type[] { String.class, String.class }; // TODO:
																								// test
																								// subclasses
																								// of
																								// Properties!
	...
	public static Type resolve(Type context, Class<?> contextRawType, Type toResolve) {
		...
		while (true) {
			if (toResolve instanceof TypeVariable) {
				...
				return changed ? newParameterizedTypeWithOwner(newOwnerType, original.getRawType(),
						args) : original;
				...
				if (originalLowerBound.length == 1) {
					...
					if (lowerBound != originalLowerBound[0]) { return supertypeOf(lowerBound); }
				} else if (originalUpperBound.length == 1) {
					Type upperBound = resolve(context, contextRawType, originalUpperBound[0]);
					if (upperBound != originalUpperBound[0]) { return subtypeOf(upperBound); }
				}
				return original;
	...
	private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
		...
		public boolean equals(Object other) {
			return other instanceof ParameterizedType
					&& GsonType.equals(this, (ParameterizedType) other);
		}
		...
		public String toString() {
			...
			if (typeArguments.length == 0) { return stringBuilder.toString(); }
	...
	private static final class GenericArrayTypeImpl implements GenericArrayType, Serializable {
		...
		public boolean equals(Object o) {
			return o instanceof GenericArrayType && GsonType.equals(this, (GenericArrayType) o);
		}
	...
	private static final class WildcardTypeImpl implements WildcardType, Serializable {
		...
		@Override
		public boolean equals(Object other) {
			return other instanceof WildcardType && GsonType.equals(this, (WildcardType) other);
		}
